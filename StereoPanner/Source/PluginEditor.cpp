...
void StereoPannerAudioProcessorEditor::resized()
{
    ...
    sliderPanPosition->setBounds (24, 64, 200, 176);
...
<JUCER_COMPONENT documentType="Component" className="StereoPannerAudioProcessorEditor"
  ...
  <SLIDER name="new slider" id="deffeab476c7c67" memberName="sliderPanPosition"
          virtualName="" explicitFocusOrder="0" pos="24 64 200 176" min="-1"
